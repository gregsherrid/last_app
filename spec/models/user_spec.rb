...
describe User do
	...
	describe "when emails format is valid" do
		it "should be valid" do
			addresses = %w[user@foo.com a_ux@g.c.org first.last@me.ORG a+b@bz.cn ]
	...
	describe "micropost associations" do
		...
		describe "status" do
			...
			its(:feed) { should include(newer_micoposts) }
			its(:feed) { should include(older_micoposts) }
